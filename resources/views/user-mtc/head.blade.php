<head>
    ...
    <title>@yield('title') ERP - User Maintenance</title>
    ...
    {{-- <link rel="icon" type="image/png" href="{{ asset('') }}" rel="stylesheet"> --}}
    ...
    <style>
        .nav-item.active {
            background-color: rgba(22, 158, 168, 0.1); /* Warna latar belakang aktif */
            border-radius: 10px;
        }
    </style>
