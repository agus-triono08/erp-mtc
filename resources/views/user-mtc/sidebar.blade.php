<ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item {{ request()->routeIs('dashboard.user-mtc') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('dashboard.user-mtc') }}">
    ...
    <!-- Nav Item - Data -->
    <li class="nav-item {{ request()->routeIs('data.user-mtc') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('data.user-mtc') }}">
            <i class="fas fa-fw {{ request()->routeIs('data.user-mtc') ? 'fa-tools' : 'fa-toolbox' }}"></i>
    ...
    <!-- Nav Item - Peminjaman -->
    <li class="nav-item {{ request()->routeIs('peminjaman.user-mtc') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('peminjaman.user-mtc') }}">
            <i class="fas fa-fw {{ request()->routeIs('peminjaman.user-mtc') ? 'fa-hands-helping' : 'fa-handshake' }}"></i>
