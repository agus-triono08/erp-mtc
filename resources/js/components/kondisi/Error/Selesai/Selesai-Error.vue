<template>
  <div class="container-fluid">
    ...
    <ul id="pills-tab" role="tablist" class="nav nav-pills mb-3" style="margin-top: 1rem !important;">
      ...
      <li role="presentation" class="nav-item">
        <router-link id="pills-contact-tab" data-toggle="pill" data-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="true" class="nav-link" :class="{ active: $route.name === 'kondisi-selesai-error' }" :to="{ name: 'kondisi-selesai-error' }">Selesai</router-link>
      </li>
    </ul>
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <router-link :to="{ name: 'kondisi-detail-selesai-error', params: { id: item.no_seri } }" class="dropdown-item">
