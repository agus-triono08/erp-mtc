  ...
  <div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item" role="presentation">
        <router-link class="nav-link" id="kategori-tab" data-toggle="tab" role="tab" aria-controls="kategori" aria-selected="true" :class="{active: $route.name === 'kondisi-baru-error'}" :to="{name: 'kondisi-baru-error'}">Baru</router-link>
      </li>
      <li class="nav-item" role="presentation">
        <router-link class="nav-link" id="merek-tab" data-toggle="tab" role="tab" aria-controls="merek" aria-selected="false" :class="{active: $route.name === 'kondisi-proses-error'}" :to="{name: 'kondisi-proses-error'}">Proses</router-link>
      </li>
      <li class="nav-item" role="presentation">
      ...
      <table class="table table-border no-border table-custom" style="overflow-x: auto;">
        <thead>
          <tr class="bg-table text-center">
            ...
            <th @click="sortBy('tgl_error')" style="cursor: pointer; color: #000;">
              Tgl Error
              <i class="fas" :class="{
                'fa-sort-up': sortKey === 'tgl_error' && sortDirection === 'asc',
                'fa-sort-down': sortKey === 'tgl_error' && sortDirection === 'desc'
              }"></i>
            </th>
            ...
            <td>
              <div
                ...
                :class="{
                  ...
                  'status-musnah': item.status === 'Proses',
                  'status-hilang': item.status === 'Belum',
                }"
              >
                {{ item.status || '-' }}
              </div>
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" @click="perbaikanData(item, 'Proses')">
                    <i class="fas fa-edit text-primary"></i> Lakukan Perbaikan
                  </a>
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      this.dataPerbaikan = data.byStatusBaru;
    },
