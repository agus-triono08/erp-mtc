            ...
            <td>
              <div 
                ...
                :class="{
                  ...
                  'status-active': item.status === 'Selesai Pemusnahan',
                }">
                {{ item.status }}
              </div>
            </td>
...
export default {
  ...
  data() {
    return {
      ...
      data: [
        { no_seri: '1122wscj121', nama: 'Clamp', tgl: '2025-02-01', kondisi: 'Error', detail: 'Sensor tidak berfungsi', pic: 'John Doe', tgl_selesai: '2025-02-05', status: 'Selesai Pemusnahan' },        
      ],
      paginatedData: [],
      searchQuery: '',
      rowsPerPage: 5,
