  ...
  <div class="container-fluid">
    ...
    <ul id="pills-tab" role="tablist" class="nav nav-pills mb-3" style="margin-top: 1rem !important;">
      <li role="presentation" class="nav-item">
        <router-link id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="false" class="nav-link" :class="{ active: $route.name === 'm-kondisi-baru-rusak' }" :to="{ name: 'm-kondisi-baru-rusak' }">Baru</router-link>
      </li>
      <li role="presentation" class="nav-item">
      ...
      <li role="presentation" class="nav-item">
        <router-link id="pills-contact-tab" data-toggle="pill" data-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="true" class="nav-link" :class="{ active: $route.name === 'm-kondisi-selesai-musnah' }" :to="{ name: 'm-kondisi-selesai-musnah' }">Selesai</router-link>
      </li>
    </ul>
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <router-link :to="{ name: 'm-kondisi-detail-selesai-musnah', params: { id: item.no_seri } }" class="dropdown-item">
