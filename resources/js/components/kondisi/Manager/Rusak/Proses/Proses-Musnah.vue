<template>
  <div class="container-fluid">
    ...
    <ul id="pills-tab" role="tablist" class="nav nav-pills mb-3" style="margin-top: 1rem !important;">
      ...
      <li role="presentation" class="nav-item">
        <router-link id="pills-profile-tab" data-toggle="pill" data-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="true" class="nav-link" :class="{ active: $route.name === 'm-kondisi-proses-musnah' }" :to="{ name: 'm-kondisi-proses-musnah' }">Proses</router-link>
      </li>
      <li role="presentation" class="nav-item">
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <router-link :to="{ name: 'm-kondisi-detail-proses-musnah', params: { id: item.no_seri } }" class="dropdown-item">
