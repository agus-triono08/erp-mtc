  ...
  <div class="container-fluid">
    ...
    <ul id="pills-tab" role="tablist" class="nav nav-pills mb-3" style="margin-top: 1rem !important;">
      <li role="presentation" class="nav-item">
        <router-link id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="false" class="nav-link" :class="{ active: $route.name === 'user-data-baru-hilang' }" :to="{ name: 'user-data-baru-hilang' }">Baru</router-link>
      </li>
      <li role="presentation" class="nav-item">
        <router-link id="pills-profile-tab" data-toggle="pill" data-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="true" class="nav-link" :class="{ active: $route.name === 'user-data-proses-hilang' }" :to="{ name: 'user-data-proses-hilang' }">Proses</router-link>
      </li>
      <li role="presentation" class="nav-item">
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <router-link :to="{ name: 'user-data-detail-proses-hilang', params: { id: item.no_ganti } }" class="dropdown-item">
...
export default {
  ...
  data() {
    return {
      ...
      data: [
        { no_ganti: 'NPG-001', no_seri: '1122wscj121', nama: 'Clamp', tgl: '2025-02-01', kondisi: 'Error', detail: 'Sensor tidak berfungsi', pic: 'John Doe', tgl_selesai: '2025-02-05', status: 'Proses' },        
      ],
      paginatedData: [],
      searchQuery: '',
      rowsPerPage: 5,
