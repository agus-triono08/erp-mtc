  ...
  <div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <router-link class="nav-link" id="kategori-tab" data-toggle="tab" role="tab" aria-controls="kategori" aria-selected="true" :class="{ active: $route.name === 'user-data-baru-hilang' }" :to="{ name: 'user-data-baru-hilang' }">Baru</router-link>
        </li>
        <li class="nav-item" role="presentation">
          <router-link class="nav-link" id="kategori-tab" data-toggle="tab" role="tab" aria-controls="kategori" aria-selected="false" :class="{ active: $route.name === 'user-data-proses-hilang' }" :to="{ name: 'user-data-proses-hilang' }">Proses</router-link>
        </li>
        <li class="nav-item" role="presentation">
          <router-link class="nav-link" id="kategori-tab" data-toggle="tab" role="tab" aria-controls="kategori" aria-selected="false" :class="{ active: $route.name === 'user-data-selesai-hilang' }" :to="{ name: 'user-data-selesai-hilang' }">Selesai</router-link>
        </li>
      </ul>
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <router-link :to="{ name: 'user-data-detail-proses-hilang', params: { id: item.id } }" class="dropdown-item">
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      this.dataKehilangan = data.byStatusProses;
