  ...
  <div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <router-link class="nav-link" id="kategori-tab" data-toggle="tab" role="tab" aria-controls="kategori" aria-selected="true" :class="{ active: $route.name === 'data-baru-hilang' }" :to="{ name: 'data-baru-hilang' }">Baru</router-link>
        </li>
        <li class="nav-item" role="presentation">
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <router-link :to="{ name: 'data-detail-baru-hilang', params: { id: item.id } }" class="dropdown-item">
