<template>
  <div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <router-link class="nav-link" id="penggantian-tab" data-toggle="tab" role="tab" aria-controls="penggantian" aria-selected="true" :class="{active: $route.name === 'data-riwayat-penggantian-mgn'}" :to="{name: 'data-riwayat-penggantian-mgn'}">Penggantian Alat/Mesin Hilang</router-link>
      </li>
    </ul>
