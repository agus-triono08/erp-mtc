...
export default {
  ...
  methods: {
    ...
    tambahData() {
      this.$router.push(`/manajer-mtc/master-data/input`);
    },
    viewDetail(id) {
      this.$router.push(`/manajer-mtc/master-data/detail/${id}`);
    },
    editData(id) {
      this.$router.push(`/manajer-mtc/master-data/edit/${id}`);
    },
    deleteData() {
      this.showModal = true;
    },
