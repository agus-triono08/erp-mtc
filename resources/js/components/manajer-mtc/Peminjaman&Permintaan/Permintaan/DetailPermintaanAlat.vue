  ...
  <div class="container-fluid">
        ...
        <div class="card shadow mb-0" style="border-radius: 10px;">
          <div class="card-body p-0" style="border-radius: 10px;">
            <div class="d-flex justify-content-between align-items-center" style="margin: 10px;">
              <h5 class="m-0 font-weight-bold" style="color: #169ea8;">Peminjaman {{ dataPermintaan.no_permintaan || '-' }}</h5>
            </div>
            <div class="row m-1">
              <div class="col-3">
                <dd>Nama Pemohon</dd>
    ...
    <div class="card shadow mb-4" style="border-radius: 10px;">
      ...
      <div class="card_body" id="app" v-if="showRincianPermintaan && dataPermintaan.no_permintaan">
        <data-rincian-permintaan-alat :no-permintaan="dataPermintaan.no_permintaan"></data-rincian-permintaan-alat>
      </div>
