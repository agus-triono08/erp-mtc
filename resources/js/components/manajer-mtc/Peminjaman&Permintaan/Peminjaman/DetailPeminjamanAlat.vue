  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4" style="border-radius: 20px;">
      ...
      <div id="app" v-if="showPengajuan && peminjaman.no_peminjaman" class="card-body">
        <pengajuan-peminjaman :no-pinjam="peminjaman.no_peminjaman"></pengajuan-peminjaman>
      </div>
      <!-- Card Konten Detail -->
      <div id="app" v-if="showDetailPeminjaman && peminjaman.no_peminjaman" class="card-body">
        <data-rincian-peminjaman-alat :no-pinjam="peminjaman.no_peminjaman"></data-rincian-peminjaman-alat>
      </div>
      <!-- Card Konten Perubahan -->
      <div id="app" v-if="showPerubahan && peminjaman.no_peminjaman" class="card-body">
        <perubahan-peminjaman :no-pinjam="peminjaman.no_peminjaman"></perubahan-peminjaman>
      </div>
...
export default {
  ...
  methods: {
    ...
    goBack(){
      this.$router.push('/manajer-mtc/peminjaman');
    }
  },
  mounted() {
