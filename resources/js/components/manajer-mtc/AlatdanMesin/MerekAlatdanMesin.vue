  ...
  <div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item" role="presentation">
        <router-link class="nav-link" id="kategori-tab" data-toggle="tab" role="tab" aria-controls="kategori" aria-selected="false" :class="{active: $route.name === 'kategori-mgn'}" :to="{name: 'kategori-mgn'}">Kategori Alat/Mesin</router-link>
      </li>
      <li class="nav-item" role="presentation">
        <router-link class="nav-link" id="merek-tab" data-toggle="tab" role="tab" aria-controls="merek" aria-selected="true" :class="{active: $route.name === 'merek-mgn'}" :to="{name: 'merek-mgn'}">Merek Alat/Mesin</router-link>
      </li>
      <li class="nav-item" role="presentation">
