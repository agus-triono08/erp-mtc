<template>
  <div class="container-fluid">
    ...
    <div class="row mb-2 align-items-center" >
      <div class="col-sm-6"><h3 style="font-family: Raleway;" class="text-black-10">Detail Perawatan Alat/Mesin</h3> 
        <h6 style="color: rgb(128, 128, 128);"></h6>
      </div> 
      <div class="col-sm-6 mt-3">
        <ol class="breadcrumb float-sm-right bg-table" style="border-radius: 10px;">
          <li class="breadcrumb-item">
            <a style="color: #169ea8; text-decoration: none;" href="javascript:history.back()">Perawatan Alat/Mesin</a>
          </li>
          <li class="breadcrumb-item active" style="color: red;">
            <span>Detail Perawatan Alat/Mesin</span>
          </li>
        </ol>
      </div>
    </div>
    ...
    <div class="card shadow">
      <div class="row m-1">
        <div class="col-12">
          <h4 class="text-capitalize text-primary text-bold"><b>No Perawatan #{{ $route.params.id }}</b></h4>
        </div>
        <div class="col-3">
        ...
        <div class="col-3">
          ...
          <dd>{{ data[0].nama }}</dd>
          <dt style="color: #000;">No Seri</dt>
          <dd>{{ data[0].no_seri }}</dd>
        ...
        <div class="col-3">
          <dt style="color: #000;">Tanggal Perawatan</dt>
          <dd>{{ data[0].tgl }}</dd>
        </div>
        <div class="col-3">
          ...
          <table class="table table-border no-border table-custom">
            <thead class="bg-table">
              <tr class="text-center" style="color: #000;">
                <th>#</th>
                <th>Tanggal Pengerjaan Perawatan</th>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAktivitasLabel">Aktivitas Perawatan</h5>
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                <label for="tanggal" class="text-black-10"><b>Tanggal Pengerjaan Perawatan <sup class="text-danger"> *</sup> </b></label>
...
export default {
  ...
  data() {
    return {
      ...
      aktivitasList: [
      { tanggal: '2025-02-01', waktu_mulai: '08:00', waktu_selesai: '12:00', pic: 'Jane Doe', detail: 'Contoh detail 1', kondisi: 'OK' },      
      ],
      data: [
  ...
  computed: {
    isLastAktivitasCompleted() {
      ...
      return lastAktivitas && (lastAktivitas.kondisi === 'OK' || lastAktivitas.kondisi === 'Rusak' || lastAktivitas.kondisi === 'Error');
    },
    isAllAktivitasCompleted() {
      return this.aktivitasList.every(item => item.kondisi === 'OK' || item.kondisi === 'Rusak' || item.kondisi === 'Error');
    },
    ...
    selesaiAktivitas() {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          this.$router.push('/admin-mtc/perawatan');
        }
      });
    },
    updatePaginatedData() {
