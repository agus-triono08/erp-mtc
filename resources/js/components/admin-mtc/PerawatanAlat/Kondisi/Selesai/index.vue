  ...
  <div class="container-fluid">
    ...
    <ul id="pills-tab" role="tablist" class="nav nav-pills mb-3" style="margin-top: 1rem !important;">
      <li role="presentation" class="nav-item">
        <router-link id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="false" class="nav-link" :class="{ active: $route.name === 'baru-perawatan' }" :to="{ name: 'baru-perawatan' }">Baru</router-link>
      </li>
      <li role="presentation" class="nav-item">
      ...
      <li role="presentation" class="nav-item">
        <router-link id="pills-contact-tab" data-toggle="pill" data-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="true" class="nav-link" :class="{ active: $route.name === 'selesai-perawatan' }" :to="{ name: 'selesai-perawatan' }">Selesai</router-link>
      </li>
    </ul>
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <router-link :to="{ name: 'detail-selesai-perawatan', params: { id: item.no_perawatan } }" class="dropdown-item">
...
export default {
  ...
  data() {
    return {
      ...
      data: [
        { no_perawatan: 'R-01', no_seri: '1122wscj121', nama: 'Clamp', tgl: '2025-02-01', kondisi: 'Error', detail: 'Sensor tidak berfungsi', pic: 'John Doe', tgl_selesai: '2025-02-05', status: 'Selesai' },        
      ],
      paginatedData: [],
      searchQuery: '',
      rowsPerPage: 5,
