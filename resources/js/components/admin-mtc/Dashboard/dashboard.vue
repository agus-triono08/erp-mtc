  ...
  <div class="container-fluid mt-3 mr-3 mb-3">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="max-width: max-content;">
                    ...
                    <tbody>
                      <tr v-for="stok in stokList" :key="stok.id">
                        ...
                        <td class="text-center">
                          <button class="btn-sm btn-primary" @click="viewDetailStok(stok.id)">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModalStok">Tutup</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="peminjamanModal" tabindex="-1" role="dialog" aria-labelledby="peminjamanModalLabel" aria-hidden="true" style="overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="max-width: max-content;">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="peminjaman in peminjamanList" :key="peminjaman.id">
                        ...
                        <td class="text-center">
                          <button class="btn-sm btn-primary" @click="viewDetailPeminjaman(peminjaman.id)">
                            <i class="fas fa-eye text-white"></i> Detail
                          </button>
                        </td>
                      </tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModal">Tutup</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="permintaanModal" tabindex="-1" role="dialog" aria-labelledby="permintaanModalLabel" aria-hidden="true" style="overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="max-width: max-content;">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="permintaan in permintaanList" :key="permintaan.id">
                        ...
                        <td>{{ permintaan.users ? permintaan.users.karyawan.nama : '-' }}</td>
                        ...
                        <td class="text-center">
                          <button class="btn-sm btn-primary" @click="viewDetailPermintaan(permintaan.id)">
                            <i class="fas fa-eye text-white"></i> Detail
                          </button>
                        </td>
                      </tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModalPermintaan">Tutup</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="perbaikanModal" tabindex="-1" role="dialog" aria-labelledby="perbaikanModalLabel" aria-hidden="true" style="overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="max-width: max-content;">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="perbaikan in perbaikanList" :key="perbaikan.id">
                        ...
                        <td class="text-center">
                          <button class="btn-sm btn-primary" @click="viewDetailPerbaikan(perbaikan.id)">
                            <i class="fas fa-eye text-white"></i> Detail
                          </button>
                        </td>
                      </tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModalPerbaikan">Tutup</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="kerusakanModal" tabindex="-1" role="dialog" aria-labelledby="kerusakanModalLabel" aria-hidden="true" style="overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="max-width: max-content;">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="kerusakan in kerusakanList" :key="kerusakan.id">
                        ...
                        <td class="text-center">
                          <button class="btn-sm btn-primary" @click="viewDetailKerusakan(kerusakan.id)">
                            <i class="fas fa-eye text-white"></i> Detail
                          </button>
                        </td>
                      </tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModalKerusakan">Tutup</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="pemusnahanModal" tabindex="-1" role="dialog" aria-labelledby="pemusnahanModalLabel" aria-hidden="true" style="overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="max-width: max-content;">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="pemusnahan in pemusnahanList" :key="pemusnahan.id">
                        ...
                        <td class="text-center">
                          <button class="btn-sm btn-primary" @click="viewDetailPemusnahan(pemusnahan.id)">
                            <i class="fas fa-eye text-white"></i> Detail
                          </button>
                        </td>
                      </tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModalPemusnahan">Tutup</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="kehilanganModal" tabindex="-1" role="dialog" aria-labelledby="kehilanganModalLabel" aria-hidden="true" style="overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="max-width: max-content;">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="kehilangan in kehilanganList" :key="kehilangan.id">
                        ...
                        <td class="text-center">
                          <button class="btn-sm btn-primary" @click="viewDetailKehilanagan(kehilangan.id)">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModalHilang">Tutup</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="perawatanModal" tabindex="-1" role="dialog" aria-labelledby="perawatanModalLabel" aria-hidden="true" style="overflow-y: auto;">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
                ...
                <div v-else class="table-responsive">
                  <table class="table table-bordered table-hover">
                    ...
                    <tr v-for="perawatan in perawatanList" :key="perawatan.id">
                      ...
                      <td class="text-center">
                        <button class="btn-sm btn-primary" @click="viewDetailPerawatan(perawatan.id)">
                            <i class="fas fa-eye text-white"></i> Detail
                          </button>
                      </td>
                    </tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModalPerawatan">Tutup</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Chart -->
      ...
      <div class="col-xl-6 col-lg-7">
        <div class="card shadow mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Statistik Peminjaman Bulanan</h6>
...
export default {
  ...
  methods: {
    ...
    viewDetailPermintaan(id) {
      ...
      // Navigasi ke halaman detail
      this.$router.push(`/admin-mtc/data-alat/permintaan/detail/${id}`);
    },
    ...
    viewDetailKerusakan(id) {
      ...
      // Navigasi ke halaman detail
      this.$router.push({ name: 'kondisi-detail-baru-rusak', params: { id } });
    },
    ...
    viewDetailKehilanagan(id) {
      ...
      // Navigasi ke halaman detail
      this.$router.push({ name: 'data-detail-baru-hilang', params: { id } });
    },
