<template>
  <div class="contaoner-fluid" style="width: 800px;">
    <!-- Header -->
    <div class="card-header">
        <h6 class="font-weight-bold" style="color: #169ea8; border-radius: 15px;">
          Form Edit Data Alat Rusak
        </h6>
      </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="tanggal_kerusakan">
                  <b>Tanggal Kerusakan</b><sup style="color: red;"> *</sup>
                </label>
                <input type="date" id="tanggal_error" class="form-control" v-model="noseri.tanggal_kerusakan" disabled required />
              </div>
            </div>
          </div>
  
          <!-- Data Layout dan Kondisi -->
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="layout">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select id="kondisi" class="form-control" required v-model="statusNoseri">
          ...
          <div class="form-group">
            ...
            <div class="textarea-wrapper">
              <textarea 
                id="detail_error" 
                class="form-control" 
                v-model="noseri.deskripsi_kerusakan"
                rows="1"
              ...
              <small class="text-muted char-counter">
                {{ noseri.deskripsi_kerusakan ? noseri.deskripsi_kerusakan.length : 0 }} / 100
              </small>
            </div>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      async fetchDataAlatBelumDigunakan() {
        ...
        try {
          const response = await axios.get(`/api/alats/datarusak/${id}/edit`);
    ...
    watch: {
      noseri: {
        handler(val) {
          ...
          this.selectedPIC = val.staff ? val.staff.nama_staff : '';
        },
        deep: true,
      },
    },
