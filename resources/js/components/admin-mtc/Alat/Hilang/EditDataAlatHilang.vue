      ...
      <div class="card-body" style="border-radius: 15px;">
        <form @submit.prevent="submitAlat">
          ...
          <div class="form-group">
            <label for="tanggal_pergantian">
              <b>Tanggal Pengantian Alat yang Hilang</b><sup style="color: red;"> *</sup>
            </label>
            <input type="date" id="tanggal_pergantian" class="form-control" v-model="noseri.tanggal_ganti" required />
          </div>                                           
  ...
  export default {
    ...
    methods: {
      ...
      async fetchDataAlatBelumDigunakan() {
        ...
        try {
          const response = await axios.get(`/api/alats/datahilang/${id}/edit`);
