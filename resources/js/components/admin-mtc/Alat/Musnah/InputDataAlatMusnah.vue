        ...
        <form @submit.prevent="submitAlat">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <!-- Tanggal Kerusakan -->
              <div class="form-group">
                <label for="tanggal_rusak" style="color: #000;">
    ...
    watch: {
      noseri: {
        handler: function (val) {
          this.selectedNoSeri = val.noseri ? val.noseri : '';
          this.selectedPIC = val.pic ? val.pic : '';
        }
      }
    }
  };
