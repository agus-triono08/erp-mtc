  ...
  <div class="container-fluid" style="width: 800px;">
    ...
    <div class="card-header">
      <h6 class="font-weight-bold" style="color: #169ea8; border-radius: 15px;">
        Form Edit Data Alat Sudah Digunakan
      </h6>
    </div>
    ...
    <div class="card-body" style="border-radius: 15px;">
      <form @submit.prevent="submitAlat">
        ...
        <div class="form-group">
          ...
          <select id="no_seri_alat" class="form-control" v-model="selectedNoSeri" required>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="no_pinjam">
                <b>No Pinjam</b><sup style="color: red;"> *</sup>
              </label>
              <input type="text" id="no_pinjam" class="form-control" v-model="noseri.no_pinjam" disabled required />
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="tanggal_pinjam">
                <b>Tanggal Pinjam</b><sup style="color: red;"> *</sup>
              </label>
              <input type="date" id="tanggal_pinjam" class="form-control" v-model="noseri.tanggal_pinjam" disabled required />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="pengguna">
                <b>Dipinjam Oleh</b><sup style="color: red;"> *</sup>
              </label>
              <input type="text" id="pengguna" class="form-control" v-model="penggunaNama" disabled required />
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="divisi">
                <b>Divisi</b><sup style="color: red;"> *</sup>
              </label>
              <input type="text" id="divisi" class="form-control" v-model="divisiNama" disabled required />
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="tanggal_pengembalian">
                <b>Tanggal Pengembalian</b><sup style="color: red;"> *</sup>
              </label>
              <input type="date" id="tanggal_pengembalian" class="form-control" v-model="noseri.tanggal_kembali" disabled required />
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" id="kondisi" class="form-control" v-model="statusNoseri" disabled required />
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <label for="status">
            <b>Status</b><sup style="color: red;"> *</sup>
          </label>
...
export default {
  ...
  methods: {
    ...
    async fetchDataAlatBelumDigunakan() {
      ...
      try {
        const response = await axios.get(`/api/peminjaman/alats/dipinjam/${id}/edit`);
  ...
  watch: {
    noseri: {
      handler(val) {
        ...
        this.selectedNoSeri = val.noseri ? val.noseri.no_seri_alat : '';
        this.divisiNama = val.pengguna ? val.pengguna.divisi : '';
        this.statusNoseri = val.noseri ? val.noseri.status : '';
      },
      deep: true,
    },
  },
