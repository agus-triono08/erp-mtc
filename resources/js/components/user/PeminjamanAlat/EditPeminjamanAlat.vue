<template>
    <div class="container-fluid">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color: #169ea8; border-radius: 15px;">Form Input Data Alat Error</h6>
      </div>
      <div class="card-body" style="border-radius: 15px;">
        <form @submit.prevent="submitAlat">
          ...
          <div class="row">
            ...
            <!-- PIC Analisa Error -->
            <div class="form-group col-md-4">
              <label for="pic-analisa" style="color: #000;">
                <b>PIC Analisa Error</b>
                <sup style="color: red;">*</sup>
              </label>
              <select id="pic_analisa" class="form-control">
                <option value="" disabled selected>Pilih PIC Analisa Error</option>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              <label for="pic_perbaikan" style="color: #000;">
                <b>PIC Perbaikan</b>
                <sup style="color: red;">*</sup>
              </label>          
              <select id="pic_perbaikan" class="form-control">
                  <option value="" disabled selected>Pilih PIC Perbaikan</option>
                  <option value="test">Test</option>              
                </select>
            </div>
            ...
            <div class="form-group col-md-6">
              <label for="tanggal_selesai_perbaikan" style="color: #000;">
                <b>Tanggal Selesai Perbaikan</b>
                <sup style="color: red;">*</sup>
              </label>
              <input
              type="date"
              id="tanggal_selesai_perbaikan"
              v-model="error.tanggal_selesai_perbaikan"
              class="form-control"
              />
            </div>
          </div>
          ...
          <!-- Detail Perbaikan -->
          <div class="form-group">
            <label for="detail-perbaikan" style="color: #000;">
              <b>Detail Perbaikan</b>
            </label>
            <div class="textarea-wrapper">
              <textarea
                id="detail-perbaikan"
                v-model="error.detail_Perbaikan"
                class="form-control"
                rows="3"
                placeholder="Masukkan Deskripsi (Maksimal 500 karakter)"
                maxlength="500"
